...
* What is the runtime complexity to access an array, add or remove from the front, and add or remove from the back?
    ...
    Accessing an item at a certain index in an array is O(1). Adding or removing from the front
    is O(n) and adding or removing from the back is O(1) best case or O(n) worst case.
